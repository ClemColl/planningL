class IndicateursController < ApplicationController
  ...
  def production
    ...
    ## Productivité
    analyzes = Equipe.first.analyzes.where(duree: 'mois').last(12)
  ...
  def data
    @rotation = RotationStock.last(12)
    @analyse_temps = AnalyseTempsProbleme.last(12)
    @ecart_stock = EcartStock.last(12)
    @taux_equip = TauxExpe.last(12)
    @taux_fa = TauxExpefa.last(12)
    @taux_client = TauxExpecc.last(12)
  end
